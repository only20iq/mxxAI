...
function scriptLoader(a,b){function c(c){let e=document.createElement("script");e.setAttribute("src",c),e.onload=function(){d++,d==a.length&&b()},document.head.appendChild(e)}let d=0;for(let d of a)c(d)}function LoadCSS(a){function b(a){return new Promise(function(b){let c=document.createElement("link");c.rel="stylesheet",c.href=a,c.onload=function(){b()},document.head.appendChild(c)})}let c=[];for(let d of a)c.push(b(d));return Promise.all(c)}
